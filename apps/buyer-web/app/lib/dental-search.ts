...
const SEARCH_INTENTS: SearchIntent[] = [
  ...
  { aliases: ["брекеты", "брекет система", "брейкиты", "брэкеты", "замочки для зубов"], terms: ["брекет-система", "ортодонтические брекеты"] },
  { aliases: ["один брекет", "отдельный брекет", "брекет на зуб", "замочек на зуб"], terms: ["одиночный брекет", "брекет для замены"] },
  { aliases: ["дуга для брекетов", "проволока для брекетов", "archwire"], terms: ["ортодонтическая дуга"] },
  { aliases: ["резинки для брекетов", "лигатуры", "ligature"], terms: ["ортодонтические лигатуры"] },
  { aliases: ["цепочка для брекетов", "эластическая цепочка", "power chain"], terms: ["эластомерная ортодонтическая цепочка"] },
];
