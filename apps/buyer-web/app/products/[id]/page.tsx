    ...
    return {
      ...
      offers: [
        ...
        },
        {
          ...
          supplierSku: "SAFETOUCH-ULTRA-100",
          price: { amountMinor: "490000", currency: "KZT" },
          packaging: { name: "Упаковка 100 штук" },
          availability: [{}],
          delivery: [{ method: "SUPPLIER_CITY" }],
          markers: { verifiedDocuments: true, officialDistributor: false },
        },
      ],
