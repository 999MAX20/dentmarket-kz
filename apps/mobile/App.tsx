    ...
    return (
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.detailScroll}>
          ...
          <Text style={styles.eyebrow}>{selected.category ?? "СТОМАТОЛОГИЧЕСКИЕ МАТЕРИАЛЫ"}</Text>
...
function BottomNav({ screen, cartCount, onChange }: { screen: "catalog" | "cart" | "profile"; cartCount: number; onChange: (screen: "catalog" | "cart" | "profile") => void }) {
