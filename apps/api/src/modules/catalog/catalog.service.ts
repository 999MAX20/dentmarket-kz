...
export class CatalogService {
  ...
  publicRelations(productId: string) {
    return this.prisma.productRelation.findMany({
      where: {
        OR: [{ fromProductId: productId }, { toProductId: productId }],
        status: "VERIFIED",
      },
      include: {
        fromProduct: { select: { id: true, canonicalName: true, slug: true } },
        toProduct: { select: { id: true, canonicalName: true, slug: true } },
      },
