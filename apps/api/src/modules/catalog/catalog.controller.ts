...
export class CatalogController {
  ...
  createAttribute(
    ...
    return this.catalog.createAttribute(parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  createCategory(
    ...
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.catalog.createCategory(parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  upsertCategoryAttributeRule(
    ...
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.catalog.upsertCategoryAttributeRule(categoryId, parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  @RequirePermissions("catalog.attribute.manage")
  removeCategoryAttributeRule(
    @Param("categoryId") categoryId: string,
    @Param("attributeId") attributeId: string,
    @Headers("x-user-id") actorId: string,
    @Headers("x-organization-id") organizationId: string,
  ) {
    return this.catalog.removeCategoryAttributeRule(categoryId, attributeId, {
      actorId,
      organizationId,
    });
  }
  ...
  @Get("managed/products/:productId/relations")
  @RequirePermissions("catalog.product.view")
  relations(@Param("productId") productId: string) {
    return this.catalog.relations(productId);
  }
  ...
  updateProduct(
    ...
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.catalog.updateProduct(productId, parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  createVariant(
    ...
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.catalog.createVariant(productId, parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  setProductAttribute(
    ...
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.attributeValues.setProductValue(productId, parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  setVariantAttribute(
    ...
    const parsed = setAttributeValueSchema.safeParse(body);
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.attributeValues.setVariantValue(variantId, parsed.data, {
      actorId,
      organizationId,
    });
  }
  ...
  @RequirePermissions("catalog.product.view")
  packagings(@Param("variantId") variantId: string) {
    return this.packaging.list(variantId);
  }
  ...
  createPackaging(
    ...
    const parsed = createProductPackagingSchema.safeParse(body);
    if (!parsed.success) throw new BadRequestException(parsed.error.flatten());
    return this.packaging.create(variantId, parsed.data, {
      actorId,
      organizationId,
    });
  }
