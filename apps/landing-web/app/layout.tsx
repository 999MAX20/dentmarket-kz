...
export const metadata: Metadata = {
  ...
  description: "B2B-маркетплейс стоматологических материалов и оборудования в Казахстане: сравнение предложений, контроль остатков, документы и договор с ЭЦП.",
